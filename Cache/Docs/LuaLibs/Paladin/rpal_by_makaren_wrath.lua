...
local items = {
	...
	{ type = "separator" },
    { type = "page", number = 1, text = "|cffFFFF00Configuración general|r" },
    { type = "separator" },
    { type = "entry", text = ni.spell.icon(6603).." Auto targeting", tooltip ="Selecciona automáticamente un objetivo cuando no está presente", enabled = true, key = "target" },
    { type = "separator" },
    { type = "entry", text = ni.spell.icon(10308).." Stan está en el mk", tooltip ="Automáticamente stan en el mk", enabled = true, key = "stan" },
    { type = "separator" },
    { type = "entry", text = ni.spell.icon(11729).." Piedra de la Salud", tooltip ="Usos del pepino en |cFF00FF00Hp <|r\
Trabaja conjuntamente con la función TTD(Time To Die)", enabled = true, value = 30, min = 1, max = 100, step = 1, key = "kamen" },
{ type = "entry", text = ni.spell.icon(48788).." Imposición de manos", tooltip = "Utiliza la imposición de manos si  |cFF00FF00Hp del miembro del grupo/raid <|r\
Trabaja conjuntamente con la función TTD(Time To Die)", enabled = true, value = 30, min = 1, max = 100, step = 1, key = "ruki" },
{ type = "separator" },
    { type = "entry", text = ni.spell.icon(24803).." Depurar para chatear", enabled = false, key = "debug" },
    { type = "page", number = 2, text = "|cffFFFF00Disipar|r" },
    { type = "separator" },
    { type = "entry", text = ni.spell.icon(4987).." Disipar", tooltip =" Disipa todo lo que puede", enabled = true, key = "decurse" },
    { type = "entry", text = " Sólo un debuff específico", tooltip ="Disipa sólo un debuff específico por su nombre", enabled = false, key = "decurse_2" },
    {
		type = "input",
    ...
    { type = "title", text = " Ignorar debuff"},
    {
		type = "input",
